...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Mata Lebuna Hema De Oya| SLMusic - Free Download sinhala songs ,Rap & Hipop  Audios |Chathuraya Productions</title>
                ...
                <div class="song-details1 margin-btm-1em color-23 artist-des-1 pad-19">
                    <div class="row margin0">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding0">
                            <h1 title=""><span class="text-51">Miya Yanna Sudanam</span><br><span class="text-52">Dinal Manusha & Kusal Harsha ft Nic yaaez </span></h1>
                        </div>
                    ...
                    <div class="row margin0">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 padding0">
                            <div class="song-profile margin-top-1em" >
                                									...
                                									<img src="./img/mata lebuna.jpg" alt="" class="img-responsive">
									                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 padding0">
                            <div class="song-details margin-btm-1em">
                                        ...
                                        <div class="row margin0">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 padding0">
                                                <h6 class="text-53">Dinal Manusha & Kusal Harsha ft Nic yaaez </h6>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 padding0 pad-9">
                            ...
                            <div class="row margin0">
                                ...
                                <div class="col-xs-7 col-sm-12 col-md-12 col-lg-12 padding0" title="Total downloads ">
                                    <h4 class="text-55"> <?php echo get_download_count('mata lebuna hema oya.mp3'); ?> </h4>
                                </div>
                            </div>
                        </div>
                    </div>
              <a href="./download.php?file=mata lebuna hema oya.mp3" class="btn btn-btn-3" data-toggle="tooltip" data-placement="above" data-original-title="">Download Mp3</a>
